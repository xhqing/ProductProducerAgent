...
- README 中英双语 + LOGO + 徽章 + 版权署名：已就绪（2026-08-20 确认）

<!-- commit-skill: license = ok -->
- LICENSE.md：已存在（2026-08-20 确认）

<!-- commit-skill: github-about = ok -->
- GitHub About：已配置（中英双语 description + topics，2026-08-20）

<!-- commit-skill: agent-persona = ok -->
- Agent 拟人名：已写入 README（Wright，2026-08-20）

<!-- commit-skill: attribution-name = ok -->
- 版权人/署名引用名字：已归一为 All Contributors（2026-08-20 确认）

<!-- commit-skill: readme-link-text = ok -->
- 英文版 README 跳转中文版链接文字：已统一为「简体中文」（2026-08-20 确认）
...
- CHANGELOG.md 与 VERSION 文件：已存在（2026-08-20 确认）
